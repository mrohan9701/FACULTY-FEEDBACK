...
<html>
    ...
    <header id="header" class="alt">
      <div class="logo"><a href="home.php">Welcome to <span> RVITM Feedback System</span></a></div>
      <a href="#menu">Menu</a>
    </header>
		...
		<!-- Two -->
			<section id="two" class="wrapper style2">
              ...
              <p> Here we have developed the a faculty feedback system, which is generally used in the college to rate the faculty based on the performance. </p>
                ...
                receive. The Faculty Feedback System is a management information system for education establishments to manage student data. An Online Feedback System is an
			  ...
			  <p>             THIS PROJECT BELONGS TO BHUVAN.K AND ROHAN.M                              </p>
						</div>
					</div>
				</div>
			</section>
