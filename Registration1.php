...
$query="insert into user values('','$n','$e','$pass','$mob','$pro','$sem','$gen','$hob','$image','$yy',now())";
...
$err="<h3 align='center' style='color: white'>Registration successfull !!<h3>";
...
<html>
   ...
   <link href="vendor/datepicker/daterangepicker.css" rel="stylesheet" media="all">
    ...
    body {
      ...
      background: url("images/computer-banner.png");
      background-size: cover;
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <option value="" disabled selected>Age</option>
								...
								<option style="color:black">19</option>
                <option style="color:black">20</option>
								<option style="color:black">21</option>
                <option style="color:black">22</option>
								<option style="color:black">23</option>
                <option style="color:black">24</option>
								<option style="color:black">25</option>
                <option style="color:black">26</option>
								<option style="color:black">27</option>
                <option style="color:black">28</option>
								<option style="color:black">29</option>
                <option style="color:black">30</option>
								<option style="color:black">31</option>
